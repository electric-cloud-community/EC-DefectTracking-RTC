    ...
    extends ComponentBase
{
    ...
    @Override public Widget doInit()
    {
        ...
        Widget htmlH1 = new HTML("<h1>Rational Team Concert Defects</h1>");

        vPanel.add(htmlH1);

        // Label label = new Label("Rational Team Concert defects associated
        // with the ElectricCommander job:");
        Widget htmlLabel = new HTML(
                "<p><b>Rational Team Concert defects associated with the ElectricCommander job:</b></p>");
        ...
        vPanel.add(new HTML(
                "<p><b>Rational Team Concert updated defects associated with the ElectricCommander job:</b></p>"));
        ...
        vPanel.add(new HTML(
                "<p><b>Rational Team Concert created defects associated with the ElectricCommander job:</b></p>"));
            ...
            final FormTable      formTable)
    {
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug(
                "Rational Team Concert Reports doInit: setting up getProperties command request");
        }
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug(
                "Rational Team Concert Reports doInit: Issuing Commander request: "
        ...
        fileDefectButton.addClickHandler(new ClickHandler() {
                ...
                public void onClick(ClickEvent event)
                {
                    ...
                    request.setProjectName(
                            "/plugins/EC-DefectTracking-RTC/project")
