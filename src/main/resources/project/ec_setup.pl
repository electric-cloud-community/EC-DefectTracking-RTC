...
if ($promoteAction eq 'promote') {
    ...
    $batch->setProperty("/plugins/EC-DefectTracking/project/defectTracking_types/@PLUGIN_KEY@", "RTC");
...
my $defectSystem = "Rational Team Concert";
my %createStep = (
...
$batch->deleteProperty("/server/ec_customEditors/pickerStep/Rational Team Concert - Create Defects");
$batch->deleteProperty("/server/ec_customEditors/pickerStep/Rational Team Concert - Link Defects");
$batch->deleteProperty("/server/ec_customEditors/pickerStep/Rational Team Concert - Update Defects");
